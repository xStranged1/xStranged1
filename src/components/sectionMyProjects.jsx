...
import xtremeGymLogo from "../assets/xtremegym.jpg";
                ...
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3">
                    ...
                    <div className="col py-3">
                        <div className="border border-1 rounded p-5 h-100 bg-body-tertiary shadow-sm">
                            ...
                            <h3 className="fs-2 text-body-emphasis">LimpiezaON</h3>
                            ...
                            <div className="d-flex gap-2 flex-wrap">
                                <button
                                    ...
                                    onClick={() => { window.location.href = "#appLimpieza"; }}
                                >
                                    {t("seeMore")}
                                </button>

                                <a
                                    href="https://xstranged1.github.io/app-limpieza-web/"
                                    target="_blank"
                                    rel="noreferrer"
                        ...
                        <div className="border border-1 border-success rounded p-5 h-100 position-relative">
                            ...
                            <div className="d-flex gap-2 flex-wrap">
                                <button
                                    ...
                                    onClick={() => { window.location.href = "#XtremeGym"; }}
                                >
                                    {t("seeMore")}
                                </button>
                    ...
                    <div className="col py-3">
                        <div className="border border-1 rounded p-5 h-100 bg-body-tertiary shadow-sm">
                            ...
                            <div style={{ flexDirection: "row" }}>
                                ...
                                <a href="https://primereact.org/" style={{ marginLeft: 20 }} target="_blank">
                                    <img src={prime} width="32" height="32" />
                                </a>
                            </div>
                            <p>{t("calendaryDesc")}</p>
                            <a className="btn btn-primary btn-lg px-4 me-md-2" target="_blank" href="https://xstranged1.github.io/Calendary/">
                                {t("seeMore")}
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="col py-3">
                        <div className="border border-1 rounded p-5 h-100 bg-body-tertiary shadow-sm">
                            ...
                            <button type="button" className="btn btn-outline-secondary btn-lg px-4"
                                onClick={() => { window.location.href = "#Consultorio"; }}>
                                {t("seeMore")}
                            </button>
                        </div>
                    </div>
