...
import womanWhite from '../assets/woman-white.png'
    ...
    return (
        <div>
            <div className="px-4 py-5 my-5 text-center" id='Consultorio'>
                ...
                {darkMode ? <img className="d-block mx-auto mb-4" src={womanWhite} alt="" width="256" height="256" /> : <img className="d-block mx-auto mb-4" src={woman} alt="" width="256" height="256" />}
